function [rho_cent, pdf_samp, src_plot, det_plot, edges, binw] = sample_p_rho_uniform_overlap_mc(diam, N_pairs_total, N_plot, Nbins)
%SAMPLE_P_RHO_UNIFORM_OVERLAP_MC  Monte-Carlo sampled p(rho) for two
% independent uniform points drawn from the same disk.
