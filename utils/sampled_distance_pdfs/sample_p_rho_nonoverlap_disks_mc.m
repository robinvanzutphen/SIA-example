function [rho_cent, pdf_samp, src_plot, det_plot, edges, binw] = sample_p_rho_nonoverlap_disks_mc(rA, rB, sep, N_pairs_total, N_plot, Nbins)
%SAMPLE_P_RHO_NONOVERLAP_DISKS_MC  Monte-Carlo sampled p(rho) for two
% laterally separated, non-overlapping disks.

if sep <= (rA + rB)
    error('This utility is for NON-overlapping disks. Choose sep > rA + rB.');
end
